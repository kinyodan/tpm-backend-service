class CharactersController < ApplicationController
  ...
  def get_all_characters
    ...
    @characters_unique = Character.select('id,book_id,url,name,gender,culture,born,died, titles,aliases,father,mother, spouse, allegiances, books, pov_books, tvSeries,played_by, created_at, updated_at').group(:url, :name)
  ...
  def character_params
    params.require(:character).permit(:book_id, :url, :name, :gender, :culture, :born, :died, :titles, :aliases, :father, :mother, :spouse, :allegiances, :books, :pov_books, :tvSeries, :played_by)
  end
end
