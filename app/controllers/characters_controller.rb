class CharactersController < ApplicationController
  ...
  def get_all_characters
    ...
    @characters_unique = Character.select('id,book_id,url,name,gender,culture,born,died, titles,aliases,father,mother, spouse, allegiances, books, pov_books, tv_series,played_by, created_at, updated_at').group(:id,:url, :name)
